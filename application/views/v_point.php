...
<div class="products">
	<div class="container">
		<h2>Products Point</h2>
		<div class="col-md-9">
			<div class="content-top1">
			<?php foreach($data->result() as $row) : ?>
				<div class="col-md-4 col-md4">
					<div class="col-md1 simpleCart_shelfItem">
						<a href="index.php/produk/detail_point/<?php echo $row->kode_point ?>">
							<img class="img-responsive" src="assets/images/<?php echo $row->img1 ?>" alt="" />
						</a>
						<h3><a href="single.html"><?php echo $row->nama_produk ?></a></h3>
						<div class="price">
							
								<h5 class="item_price"><?php echo $row->point ?></h5>

								<a href="index.php/produk/detail_point/<?php echo $row->kode_point ?>" class="item_add">Detail</a>
