						...
						<div class="row text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  						...
  						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th  data-align="left" data-sortable="true">Info</th>
								<th  data-align="left" data-sortable="true">Setting</th>
							...
							<td>
								<?php       
										            $image = array(
										              'src' => 'assets/web/images/'.($row->slide),
										              'class' => 'photo',
										              'width' => '140',
										              'height' => '80',
										              'rel' => 'lightbox',
							...
							<td>
								<a href="<?php echo base_url();?>index.php/ci_admin/v_edit_slide/<?php echo $row->id_slide ?>" class="btn btn-success btn-small">EDIT</a>
							</td>
