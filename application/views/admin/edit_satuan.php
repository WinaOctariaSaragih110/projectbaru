   ...
   ?>
            <div class="row">
              <div class="col-md-12">
               ...
               <form method="post" action="<?php echo base_url(); ?>index.php/ci_admin/proses_edit_satuan" enctype="multipart/form-data">
           ...
           ?>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <input type="number" class="form-control" value="<?php echo $key->harga_member ?>"  name="harga_member"  required>
                      <input type="hidden" value="<?php echo $key->id_satuan ?>"  name="id_satuan"  required>
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <input type="number" class="form-control" value="<?php echo $key->harga_member ?>"  name="harga_nonmember"  required>
                    </div>
                  </div>
        ...
        <a href="<?php echo base_url();?>index.php/ci_admin/stok" class="btn btn-primary btn-small">Tutup</a>
    </div>
        </div>
        </form>
