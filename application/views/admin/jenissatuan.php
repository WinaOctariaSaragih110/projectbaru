				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      						<a  href="<?php echo base_url();?>index.php/ci_admin/tambah_jenissatuan" class="btn btn-primary btn-small" ><span class="glyphicon glyphicon-plus"></span>&nbsp;Tambah data</a>
  						</div>
  						...
  						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th  data-align="left" data-sortable="true">Nilai</th>
							...
							<td>
      						<a  href="<?php echo base_url() ?>index.php/ci_admin/edit_jenissatuan/<?php echo $row->id_jenissatuan ?>" class="btn btn-primary btn-small" >
      						
      						<span class="glyphicon glyphicon-plus"></span>&nbsp;Edit</a>
							<a href="<?php echo base_url() ?>index.php/ci_admin/hapus_jenissatuan/<?php echo $row->id_jenissatuan ?>" >
