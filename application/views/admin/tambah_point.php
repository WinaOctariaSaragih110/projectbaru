<form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/ci_admin/proses_tambah_point" enctype="multipart/form-data" ><br><br>
    <div class="form-group">
        <label class="control-label col-sm-2" for="fieldtwo">Kode Point</label>
        <div class="col-sm-5">
        <input type='text' name='kode_point' value="<?php echo $kodeunik ?>" style="color:red" class='form-control' required='required' disabled="disable">
              <input type="hidden" name="kode_point" value="<?php echo $kodeunik ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input required type="number" name="point"  class="form-control" value="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <textarea name="keterangan" style="width: 505px; height: 87px;"></textarea>        
        </div>
    </div>
    <div class="form-group">
