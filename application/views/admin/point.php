						...
						<div class="row text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  						...
  						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th  data-align="left" data-sortable="true">Nama Produk</th>
							...
							<td>
      						<a  href="<?php echo base_url() ?>index.php/ci_admin/edit_point/<?php echo $row->kode_point;?>" class="btn btn-primary btn-small">
      						<span class="glyphicon glyphicon-plus"></span>&nbsp;Edit</a>
							
							<a href="<?php echo base_url() ?>index.php/ci_admin/hapus_point/<?php echo $row->kode_point;?>">
