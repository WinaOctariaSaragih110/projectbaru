       ...
       document.getElementById("new_select").innerHTML=response; 
            ...
            <div class="row">
              <div class="col-md-12">
               ...
               <form method="post" action="<?php echo base_url(); ?>index.php/ci_admin/proses_edit_stok" enctype="multipart/form-data">
  ...
  ?>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <input type="number" class="form-control" value="<?php echo $rows->stok ?>"  name="stok" placeholder="Jumlah Stok" required>
                    </div>
                  </div>
